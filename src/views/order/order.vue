<template>
  <div class="app-container">
    <div class="filter-container">
      <el-input style="width: 150px;" class="filter-item" placeholder="请输入商品名称">
      </el-input>
      <el-select clearable style="width: 150px" class="filter-item" v-model="listQuery.importance" placeholder="选择分类">
      ...
      <el-table :data="tableData" border style="width: 100%" v-loading="loading">
        ...
        <el-table-column prop="province" label="商品缩略图">
        </el-table-column>
        <el-table-column prop="name" label="商品名称">
        </el-table-column>
        <el-table-column prop="address" label="购买人">
        </el-table-column>
        <el-table-column prop="zip" label="价格">
        </el-table-column>
        <el-table-column prop="iphone" label="购买人电话">
        </el-table-column>
...
export default {
  data() {
    return {
      ...
      importanceOptions: [{ key: '房券' }, { key: '餐券' }],
      list: [{ key: '热推' }, { key: '非热推' }],
      tableData: [{
        date: '1',
        name: '餐券 ',
