<template>
  ...
  <div class="banner">
    <div class="banneradd">
      <el-button type="primary" size="mini" @click="handleUpdate()" icon="el-icon-plus">新增商品</el-button>
    </div>
    <div class="bannerlist-box">
      <div class="filter-container" style="width: 100%">
        <el-table :data="tableData" border style="width: 100%" v-loading="loading">
          ...
          <el-table-column prop="img" label="首页商品图片">
          </el-table-column>
          <el-table-column prop="url" label="商品类型" >
          </el-table-column>
