<template>
  ...
  <div class="banner">
    <div class="banneradd">
      <el-button type="primary" size="mini" @click="handleUpdate()" icon="el-icon-plus">新增大厅</el-button>
    </div>
    <div class="bannerlist-box">
      <div class="filter-container" style="width: 100%">
        <el-table :data="tableData" border style="width: 100%" v-loading="loading">
          ...
          <el-table-column prop="name" label="大厅名称" >
          </el-table-column>
          <el-table-column prop="img" label="大厅图片">
          </el-table-column>
          <el-table-column prop="url" label="商品数量" >
          </el-table-column>
          <el-table-column prop="state" label="是否显示在首页">
          ...
          <el-table-column label="操作" width="500px">
            <template slot-scope="scope">
              <el-button @click="show()" type="primary" size="small">查看详情</el-button>
              <el-button @click="add()" type="success" size="small">添加商品</el-button>
    ...
    <el-dialog v-el-drag-dialog @dragDialog="handleDrag" title="大厅吧" :visible.sync="dialogTableVisible">
      <el-table :data="gridData">
        <el-table-column property="date" label="id"></el-table-column>
    ...
    <el-dialog v-el-drag-dialog @dragDialog="handleDrag" title="添加商品" :visible.sync="showadd">
